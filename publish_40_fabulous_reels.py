...
CSV_FILE = "lasavo_books_40_fabulous_reels.csv"
LOG_FILE = "fabulous_40_reels_pub.log"
BASE_ASSET_URL = "https://lasavo-school.netlify.app/social_assets/"

IG_USER_ID = "17841427210786438"   # Instagram Business Account for @lasavobooks
FB_PAGE_ID = "1222908690916687"    # Facebook Page ID for Lasavo Books
...
def run():
    with open(LOG_FILE, "w", encoding="utf-8") as f:
        f.write("=== 40 FABULOUS REELS LASAVOBOOKS PUBLISHER ===\n")
    ...
    log(f"\nStarting publishing of {len(items)} Fabulous Reels directly to @lasavobooks...")
    ...
    log(f"\n==================================================")
    log(f"40 Fabulous Reels Execution Complete! IG Success: {ig_success}, Failures: {fail_count}")
    log(f"==================================================")
